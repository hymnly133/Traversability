...
- lightweight octree-backed sparse voxel index for occupied NDT leaves and neighborhood retrieval
...
- robot-centric local terrain map extraction as a sliding high-resolution window for paper pipeline and receding-horizon local planning
...
- NDT implicit voxel-map checks pass for octree indexing, incremental integration, SVD roughness/slope, sparsity, and terrain/collision/falling traversal-risk detection
