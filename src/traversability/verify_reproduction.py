...
def main() -> None:
    ...
    subprocess.run([sys.executable, "-m", "traversability.verify_paper_pipeline"], check=True)
    subprocess.run([sys.executable, "-m", "traversability.verify_paper_receding"], check=True)
